    ...
    const fetchBrandGrid = async () => {
      ...
      try {
        ...
        setStats({
          ...
          availableCapital: brandData.reelcoins || 0
        });
    ...
    <div className="min-h-screen bg-[#f8f8f8] text-black font-lexend">
      ...
      {selectedMission && (
        <div className="fixed inset-0 z-[500] flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-white w-full max-w-4xl max-h-[85vh] border-[6px] border-black shadow-[24px_24px_0px_0px_#0047AB] relative flex flex-col overflow-hidden animate-in zoom-in-95">
            <button 
            ...
            <div className="bg-[#0047AB] p-10 text-white border-b-[6px] border-black">
              <p className="text-[10px] font-black uppercase tracking-[0.4em] mb-2 text-[#00ffcc]">Applicant Data Sync</p>
                ...
                <div className="space-y-12">
                  <section>
                    <div className="flex items-center gap-3 mb-6">
                      <Clock size={18} className="text-[#0047AB]" />
                      ...
                      {missionSubmissions.filter(s => s.status === 'pending').map(sub => (
                        <div key={sub.id} className="bg-white border-[4px] border-black p-6 shadow-[6px_6px_0px_0px_#000] flex items-center justify-between">
                          <div className="flex items-center gap-6">
                            <div className="w-14 h-14 border-[3px] border-black shadow-[3px_3px_0px_0px_#00ffcc] overflow-hidden bg-slate-100">
                            ...
                            <div>
                              ...
                              <p className="text-[10px] font-bold text-[#0047AB] uppercase tracking-widest mt-1">@{sub.profiles?.handle || 'unlinked'}</p>
                            </div>
                          </div>
                          {sub.link && (
                            <a href={sub.link} target="_blank" rel="noreferrer" className="flex items-center gap-2 bg-black text-white px-4 py-2 border-[2px] border-black text-[9px] font-black uppercase tracking-widest hover:bg-[#00ffcc] hover:text-black transition-all">
                      ...
                      {missionSubmissions.filter(s => s.status === 'approved' || s.status === 'completed').map(sub => (
                        <div key={sub.id} className="bg-emerald-50/50 border-[4px] border-emerald-500 p-6 flex items-center justify-between opacity-80">
                          <div className="flex items-center gap-6">
                            ...
                            <div>
                              <p className="font-black text-sm uppercase italic text-emerald-900">{sub.profiles?.display_name}</p>
      ...
      {/* STICKY HEADER */}
      <header className="bg-white border-b-[6px] border-[#0047AB] sticky top-0 z-[100] px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-6">
            <div className="w-12 h-12 border-[3px] border-black shadow-[3px_3px_0px_0px_#0047AB] overflow-hidden bg-white p-1">
              {brand.logo_url ? (
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-[9px] font-black uppercase tracking-[0.4em] text-[#0047AB] mt-1">Alliance Dashboard v4.2</p>
            </div>
          </div>

          <div className="flex items-center gap-4">
            <div className="hidden md:flex items-center gap-2 bg-[#00ffcc] border-[2px] border-black px-3 py-1 shadow-[2px_2px_0px_0px_#000]">
      ...
      <main className="max-w-7xl mx-auto p-6 lg:p-12 space-y-12">
        ...
        <div className="bg-white border-[6px] border-black p-10 shadow-[16px_16px_0px_0px_#000] relative overflow-hidden flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="space-y-6 relative z-10 text-center md:text-left">
            <div className="inline-flex items-center gap-2 bg-[#0047AB] text-white px-4 py-1 border-[2px] border-black font-black text-[10px] uppercase tracking-widest italic">
              <Flame size={14} className="text-[#00ffcc] animate-pulse" />
              Alliance Fidelity Status: High
            </div>
            <h2 className="text-6xl font-black italic uppercase font-display tracking-tighter leading-none">Campaign <br /><span className="text-[#0047AB]">Performance</span></h2>
            <p className="text-sm font-bold uppercase leading-relaxed text-black/50 max-w-md border-l-[6px] border-black pl-6 py-2">
              Real-time monitoring of your creative assets and partner network engagement levels.
            </p>
          </div>

          <div className="bg-black text-white p-10 border-[5px] border-black shadow-[10px_10px_0px_0px_#00ffcc] text-center min-w-[320px]">
             <p className="text-[10px] font-black uppercase tracking-[0.4em] opacity-50 mb-4 italic">AVAILABLE CAPITAL (RC)</p>
             <h3 className="text-6xl font-black italic font-display text-[#00ffcc] tracking-tighter">{stats.availableCapital.toLocaleString()}</h3>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white p-8 border-[4px] border-black shadow-[8px_8px_0px_0px_#000] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all group">
            <div className="w-14 h-14 bg-[#00ffcc] border-[3px] border-black flex items-center justify-center mb-6 shadow-[4px_4px_0px_0px_#000] group-hover:rotate-6 transition-transform">
          ...
          <div className="bg-white p-8 border-[4px] border-black shadow-[8px_8px_0px_0px_#000] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all group">
            <div className="w-14 h-14 bg-[#0047AB] border-[3px] border-black flex items-center justify-center mb-6 shadow-[4px_4px_0px_0px_#000] group-hover:-rotate-6 transition-transform text-white">
          ...
          <div className="bg-white p-8 border-[4px] border-black shadow-[8px_8px_0px_0px_#000] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all group">
            <div className="w-14 h-14 bg-black border-[3px] border-black flex items-center justify-center mb-6 shadow-[4px_4px_0px_0px_#0047AB] group-hover:scale-110 transition-transform text-white">
          ...
          <div className="bg-white p-8 border-[4px] border-black shadow-[8px_8px_0px_0px_#000] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all group">
            <div className="w-14 h-14 bg-white border-[3px] border-black flex items-center justify-center mb-6 shadow-[4px_4px_0px_0px_#00ffcc] group-hover:translate-x-1 transition-transform">
              <TrendingUp size={24} strokeWidth={3} className="text-[#0047AB]" />
            </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          <div className="lg:col-span-8 bg-white border-[6px] border-black p-10 shadow-[12px_12px_0px_0px_#000]">
            <div className="flex items-center justify-between mb-10">
              <h3 className="text-3xl font-black italic uppercase font-display flex items-center gap-4">
                <Activity size={28} className="text-[#0047AB]" /> Mission Activity Log
              </h3>
                ...
                {activeMissions.length === 0 ? (
                  ...
                  activeMissions.map((m) => (
                    <div key={m.id} className="flex items-center justify-between border-b-4 border-slate-50 pb-8 last:border-0 hover:bg-slate-50 transition-colors px-4 -mx-4 group/row">
                      <div className="flex items-center gap-6">
                        <div className="w-14 h-14 bg-black text-[#00ffcc] border-[3px] border-black shadow-[4px_4px_0px_0px_#000] flex items-center justify-center group-hover/row:rotate-3 transition-transform">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            <span className="text-[9px] font-black uppercase text-[#0047AB] tracking-widest">BOUNTY: {m.reward_amount} RC</span>
                      ...
                      <div className="flex items-center gap-4">
                        <button 
                          ...
                          className="bg-black text-white px-5 py-3 border-[3px] border-black shadow-[4px_4px_0px_0px_#0047AB] font-black uppercase text-[9px] tracking-widest hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all active:scale-95"
                        >
                          VIEW APPLICANTS
                        </button>
                      </div>
          ...
          <div className="lg:col-span-4 space-y-12">
            <div className="bg-[#00ffcc] border-[6px] border-black p-10 shadow-[12px_12px_0px_0px_#000] text-black">
              ...
              <p className="text-sm font-bold uppercase leading-relaxed tracking-tight italic border-l-4 border-black pl-6 py-2">
                "Operational liquidity is stable. Recommend expanding the 'High Fidelity' mission nodes for premium content creators to maximize evening conversion yield."
              </p>
              <button className="w-full mt-10 bg-black text-[#00ffcc] py-5 border-[3px] border-white shadow-[6px_6px_0px_0px_#000] font-black uppercase text-[10px] tracking-[0.2em] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all">Optimize Strategy</button>
            </div>

            <div className="bg-white border-[6px] border-black p-10 shadow-[12px_12px_0px_0px_#0047AB] space-y-6">
              <h4 className="text-xl font-black uppercase italic font-display flex items-center gap-3">
                <Target size={20} className="text-[#0047AB]" /> Grid Control
              </h4>
