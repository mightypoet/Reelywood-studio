    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="relative group">
        <input 
          ...
          placeholder=" "
          className="peer w-full bg-white/5 border border-white/10 rounded-2xl px-5 pt-7 pb-3 text-sm focus:outline-none focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/10 transition-all placeholder-transparent"
        />
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="relative group">
          <select
            ...
            value={data.platform}
            onChange={handleChange}
            className="peer w-full bg-white/5 border border-white/10 rounded-2xl px-5 pt-7 pb-3 text-sm focus:outline-none focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/10 transition-all appearance-none"
          >
            <option value="" disabled className="bg-[#0a0a0a]">Select</option>
            {platforms.map(p => (
              <option key={p.id} value={p.id} className="bg-[#0a0a0a]">{p.id}</option>
            ))}
          </select>
