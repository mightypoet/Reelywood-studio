  ...
  useEffect(() => {
    ...
    const newHTML = words
      .map(word => {
        ...
        return `<span
          class="inline-block mx-[4px] my-[2px] select-none cursor-grab active:cursor-grabbing transition-colors duration-300 ${isHighlighted ? 'text-indigo-600 font-extrabold' : 'text-slate-400 font-semibold'}"
        >
          ${word}
        </span>`;
      })
