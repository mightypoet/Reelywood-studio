      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-20 w-full">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-24 items-center">
          ...
          <div className="lg:col-span-8 space-y-8 lg:space-y-12 animate-in fade-in slide-in-from-left-8 duration-1000 ease-out">
            ...
            {/* Intelligence Badge */}
            <div className="inline-flex items-center space-x-3 bg-black border-[2px] border-black px-4 py-2 rounded-full text-white font-black text-[9px] sm:text-[10px] uppercase tracking-[0.3em] shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)]">
            ...
            <div className="space-y-0 flex flex-col">
              <h1 className="flex flex-col text-5xl sm:text-7xl md:text-8xl lg:text-[115px] font-black text-white leading-[0.85] tracking-tighter font-display uppercase">
                <span>Apply for</span>
                <span className="mt-1">creator</span>
                <span className="mt-1">card</span>
              </h1>
              <h2 className="text-[#ffde59] text-4xl sm:text-7xl md:text-8xl lg:text-[105px] italic hero-stroke font-black uppercase tracking-tighter leading-[0.85] mt-4 block">
                With Reelywood
              </h2>
              <p className="text-sm sm:text-base md:text-xl text-white font-bold leading-relaxed max-w-2xl pt-8 sm:pt-12 tracking-tight">
