        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          <div className="lg:col-span-8 space-y-10 lg:space-y-12 animate-in fade-in slide-in-from-left-8 duration-1000 ease-out">
            ...
            <div className="space-y-4">
              ...
              <h2 className="text-[#ffde59] text-5xl md:text-8xl lg:text-[100px] italic hero-stroke font-black uppercase tracking-tighter leading-none">
                With Reelywood
              </h2>
              <p className="text-base md:text-lg text-white/95 leading-relaxed max-w-2xl font-bold pt-4">
          ...
          <div className="hidden lg:flex lg:col-span-4 relative items-center justify-center animate-in fade-in zoom-in duration-1000 delay-300">
            <div className="relative w-full aspect-[4/5] max-w-[400px] overflow-hidden border-4 border-black shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] bg-black/5">
